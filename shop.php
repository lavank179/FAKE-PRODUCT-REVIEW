						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="link-effect-4" id="link-effect-4">
								<ul class="nav navbar-nav">
									...
									<li><a href="index.html"><span data-hover="Login">Logout</span></a></li>
								</ul>
							</nav>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="student-grids">
						<div class="col-md-6 student-grid">
							...
							<ul class="grid-part">
								<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Kelambakkam, Chennai</li>
								<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>8072097287</li>
								<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:chlavankumar179@gmail.com"> chlavankumar179@gmail.com</a></li>
							</ul>
