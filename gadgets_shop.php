<?php
	...
	$sql2 = "SELECT polarity,subjectivity FROM products where pid = '$pid'";
			...
			<table align="center">
				...
				<tr>
					...
					<?php 
							 ...
							 if(($row2['polarity'] && $row2['subjectivity']) > 0){ 
							 echo "<br>";
							 $polarity = $row2['polarity'];
							 $subjectivity = $row2['subjectivity'];

							  echo "<p><b>Polarity: {$polarity}</b></p><p><b>Subjectivity: {$subjectivity}</b></p>";
							} else {
							   echo "<br>";
							 
							  echo "<p><b>Polarity: Not Available</b></p><p><b>Subjectivity: Not Available</b></p>";
